from .tool_setup_models import SkillSpec, ToolSpec


def build_skill_specs(specs: list[ToolSpec]) -> dict[str, SkillSpec]:
    return {
        "project_core": SkillSpec(
            "project_core",
            "Project Core Skill",
            "Core project editing tools for loading, updating, validating, and rendering projects.",
            [
        ...
        "asset_discovery": SkillSpec(
            ...
            "Search and download stock assets for use in a project.",
            ["search_net_asset", "download_net_asset"],
            keywords=["search", "download", "asset", "stock", "pexels", "pixabay", "freesound"],
        ),
        "vision_inspection": SkillSpec(
            "vision_inspection",
            "Vision Inspection Skill",
            "Inspect image or video content and extract visual observations.",
            ["vision_analyze_media"],
            keywords=["vision", "inspect", "analyze", "analysis", "image", "video", "media", "ocr", "frame", "scene", "summary", "visual", "识别", "画面", "视频分析", "图片分析"],
        ),
    }
