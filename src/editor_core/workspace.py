...
class ProjectWorkspace:
    ...
    def to_storage_path(self, path: str | Path) -> str:
        ...
        try:
            return str(candidate.relative_to(self.root.resolve()))
        except ValueError:
...
class WorkspaceRegistry:
    ...
    def _new_workspace(self, source_path: str | Path, project_name: Optional[str] = None) -> ProjectWorkspace:
    ...
    def find_or_create(self, source_path: str | Path, project_name: Optional[str] = None) -> Tuple[ProjectWorkspace, bool]:
