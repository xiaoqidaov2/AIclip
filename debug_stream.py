...
def main():
    ...
    agent = AgentBuilder.build_agent(
        ...
        system_prompt=tool_setup.build_system_prompt(
            "You are a core project editing assistant.", skill_name=skill_name
        ),
    )
        ...
        if isinstance(chunk, dict):
            ...
            for key, value in chunk.items():
                ...
                if hasattr(value, "keys"):
                    ...
                    print(
                        f"Sub-keys: {value.keys() if isinstance(value, dict) else 'N/A'}"
                    )
